...
def generar_excel_estilizado(df_data, es_control=False):
    ...
    # Formato de Información General en Excel
        ...
        for cat in df_data["Categoría"].unique():
            ...
            for _, row in subset.iterrows():
                ...
                for idx, v in enumerate(vals, 1):
                    ...
                    header_name = headers[idx-1]
                    # Aplicamos el porcentaje y el semáforo al ítem individual
                    if es_control and header_name == "% GANANCIA":
                    ...
                    # Si no es porcentaje, verificamos si es moneda
                    elif any(x in header_name for x in ["UNIT", "TOTAL", "VENTA", "GANANCIA", "SUBTOTAL", "PRECIO"]):
...
def generar_pdf():
    ...
    for cat in df_validos["Categoría"].unique():
        ...
        pdf.cell(75, 8, "DESCRIPCIÓN", 1, 0, 'L', True); pdf.cell(15, 8, "DIAS", 1, 0, 'C', True); pdf.cell(20, 8, "CANT.", 1, 0, 'C', True); pdf.cell(40, 8, "UNITARIO", 1, 0, 'C', True); pdf