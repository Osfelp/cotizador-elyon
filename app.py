...
st.markdown(f"""
    ...
    /* Botones de Descarga Activos */
    div[data-testid="column"]:nth-of-type(1) [data-testid="stDownloadButton"] > button:not(:disabled) {{
        background: linear-gradient(135deg, #008f39 0%, #006829 100%) !important;
    }}
    div[data-testid="column"]:nth-of-type(2) [data-testid="stDownloadButton"] > button:not(:disabled) {{
        background: linear-gradient(135deg, #d35400 0%, #e67e22 100%) !important;
    }}
    div[data-testid="column"]:nth-of-type(3) [data-testid="stDownloadButton"] > button:not(:disabled) {{
        background: linear-gradient(135deg, #2980b9 0%, #1f618d 100%) !important;
    }}
    
    /* Botones Bloqueados (Gris) */
    [data-testid="stDownloadButton"] > button:disabled {{
        background: #3a3b3c !important; color: #888888 !important; cursor: not-allowed !important;
    }}
