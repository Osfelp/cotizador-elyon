...
st.markdown(f"""
    ...
    /* 1. Dashboard Financiero (Tarjetas de Totales) */
    ...
    /* 2. Botones de Exportación Sólidos e Imponentes */
    ...
    /* 3. Tarjetas Premium del Sidebar */
    .sidebar-card {{
    ...
    [data-testid="stSidebar"] [data-testid="stDownloadButton"] button {{
        background: linear-gradient(135deg, #2980b9 0%, #154360 100%) !important; color: white !important; border: none !important; font-weight: bold !important; height: 3em !important;
    }}
    
    /* 4. Alineación Perfecta de Lápiz y Papelera */
    .btn-edit button {{ 
        background-color: #2c3e50 !important; color: white !important; 
        height: 36px !important; padding: 0px 15px !important; border-radius: 8px !important; border: none !important; margin-top: 13px !important;
    }}
...
# --- SISTEMA DE RECARGA MEJORADO VISUALMENTE (SIDEBAR) ---
...
for i, cat_name in enumerate(list(st.session_state.cat_order)):
    # Proporciones ajustadas para mantener los botones pegados al título
...
# Dashboard financiero renderizado con las nuevas tarjetas
