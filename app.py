...
st.markdown(f"""
    ...
    /* COLORES INDIVIDUALES PARA LOS BOTONES DE DESCARGA (Tonos Acordes y Elegantes) */
...
def generar_pdf():
    ...
    if wm_bytes:
        ...
        # Marca de agua aún más pequeña y mejor centrada verticalmente
        # w=80, x=68 (centrado en ancho 215.9), y=80 (un poco más arriba)
...
# --- FIRMA / MARCA DE AGUA EN LA PLATAFORMA ---
st.markdown("<div style='text-align: center; font-size: 10px; color: #444746; padding-top: 50px;'>by Oscar Buitrago / Elyon Producciones.</div>", unsafe_allow_html=True)